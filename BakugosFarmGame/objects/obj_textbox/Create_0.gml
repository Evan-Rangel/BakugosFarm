...
page_number = 0;
//Textos prueba//
text[0] = "El hambre en el mundo seria menor si matamos a los pendejos"; //Un arreglo de texto para guardar todas las palabras que estaran en la paguina.
text[1] = "popo!";
text[2] = "Chingas a tu madre puto watanoge de mierda juro que cuando te encuentre te voy a dar de tragar las extremidades de tus pendejos familiares, JODETE!";
////
